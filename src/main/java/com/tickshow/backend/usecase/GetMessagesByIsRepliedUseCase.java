...
@AllArgsConstructor
public class GetMessagesByIsRepliedUseCase {
    private final ContactRepository contactRepository;

    public PageableCoreContact execute(boolean isReplied, int page) {
        Page<Contact> contactPage = contactRepository.findAllByRepliedOrderByDateTime(
                isReplied,
